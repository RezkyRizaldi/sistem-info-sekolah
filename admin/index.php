...
<head>
  ...
  <title>Admin - Sistem Penilaian SMK Prakarya Internasional [SMK PI]</title>
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      <li class="nav-item dropdown no-arrow mx-1">
        <a class="nav-link dropdown-toggle bg-dark" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">26 Siswa baru terdaftar !</div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">11 Guru baru mendaftar !</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
                <span class="float-left">Selengkapnya</span>
                <span class="float-right">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">123 Nilai baru masuk !</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
                <span class="float-left">Selengkapnya</span>
                <span class="float-right">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">13 Nilai baru masuk !</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
                <span class="float-left">Selengkapnya</span>
                <span class="float-right">
